// 5 kyu kata
// https://www.codewars.com/kata/52dd72494367608ac1000416/solutions/javascript/me/best_practice
...
function isPrime(num){
  ...
  function getPrimes(start, finish) {
    return [...Array(Math.max(start,finish)+1).keys()].filter(x=> x >= Math.min(start,finish)).filter(x=>isPrime(x))
  }